...
class Message(Base):
    ...
    # Comentário encaminhado dentro da conversa. Opcional.
    ...
    shared_comment: Mapped[Optional["Comment"]] = relationship("Comment", foreign_keys=[shared_comment_id])  # noqa: F821
