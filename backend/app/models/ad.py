...
class AdCreative(Base):
    ...
    # Conta do Daqui vinculada (só faz sentido no formato "post") — o
    # frontend resolve via api.getUser(id) e renderiza como post real.
...
# curtida/repost/comentário são identificados por `user_id` (FK pra User).
