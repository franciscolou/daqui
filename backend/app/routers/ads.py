...
from app.schemas.ad_settings import AdSettingsOut
...
# Painel de anúncios (ads-admin/): gerido pelo time interno, autenticado via
# /ads-admin/auth/login (get_current_ad_admin) — conta AdAdmin própria, sem
# relação com o User/is_moderator do Daqui.
