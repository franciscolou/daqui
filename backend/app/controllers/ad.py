...
from app.core.deps import get_current_ad_admin, get_current_ads_owner, get_db
...
def admin_get_settings(
    db: Session = Depends(get_db),
    _admin: AdAdmin = Depends(get_current_ads_owner),
) -> AdSettingsOut:
...
def admin_create_manual_campaign(
    ...
    db: Session = Depends(get_db),
    admin: AdAdmin = Depends(get_current_ad_admin),
) -> CampaignAdminOut:
