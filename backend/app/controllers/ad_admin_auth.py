...
from app.core.deps import get_current_ad_admin, get_db
...
from app.services import ad_admin_auth as auth_service


def me(current_admin: AdAdmin = Depends(get_current_ad_admin)) -> AdAdminMe:
...
def two_factor_setup(
    ...
    current_admin: AdAdmin = Depends(get_current_ad_admin),
) -> TwoFactorSetupResponse:
