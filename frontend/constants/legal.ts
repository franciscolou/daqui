...
export const LEGAL_UPDATED_AT = '2026-07-25T12:00:00Z';
...
export const TERMS_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      p('O bairro cadastrado como "Meu bairro" deve ser onde você realmente mora. Você pode optar por esconder o selo de morador em Privacidade e segurança > Ocultar selo de morador. Ao configurá-lo ou alterá-lo (em Configurações > Meu endereço), você atesta a veracidade dessa informação. Configurar sua residência em um bairro onde você não mora configura-se como uma violação da organização do aplicativo e acarreta em suspensão da sua conta.'),
    ],
  },
  {
